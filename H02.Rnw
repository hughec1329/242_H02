	...
	\section{Simulation}
		...
		\subsection{Effect of \rho on Velocity.}
			...
			\begin{figure}[h!]
				...
				\includegraphics[scale=0.5]{figure=rho22.jpg}
				\caption{effect of \rho on average velocity, increased resolution at inversion.}
			\end{figure}

			\begin{figure}[h]
				\centering
				\includegraphics[scale=0.5]{figure=t500.jpg}	% need to convert this file from png to jpeg.
		...
		\subsection{Effect of map size on Velocity}
			...
			\begin{figure}[h!]
				\centering
				\includegraphics[scale=0.5]{figure=sizev.jpg}
		...
		\subsection{Effect of percent color mix on Velocity}
			...
			\begin{figure}[h!]
				\centering
				\includegraphics[scale=0.5]{figure=colorv.jpg}
